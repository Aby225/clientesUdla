	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','display','result'),
				'users'=>array('@'),
			),
	...
	public function actionView($id)
	{
		...
		if (Yii::app()->user->id == $model->userId)
         {   
			...
			//$this->render('update 2', array('model'=>$vot)); 

 			/*$this->render('_form2',array(
			'model'=>$this->loadModel($id),
			));*/
 			//$this->redirect(Yii::app()->createUrl(array('votingHistory/create','pId'=>$model->id)));
 			$this->redirect(array('votingHistory/create', 'pId'=>$model->id));
 		}	
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Poll']))
		{
			...
			if($model->save())
				...
				$this->redirect(array('question/create', 'pId'=>$model->id));
		}
