        ...
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'encodeLabel'=>false,
                    'items'=>array(
						array('label'=>'Home <span></span>', 'url'=>array('/site/index')),
                        /*,'itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"our home page"), 
                        'items'=>array(
						...
						array('label'=>'Admin <span></span>', 'url'=>'#', 'visible'=>!Yii::app()->user->isGuest,'itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>""), 
                        'items'=>array(

                        array('label'=>'Usuarios', 'url'=>array('/user'),'visible'=>!Yii::app()->user->isGuest, 'view'=>'index'),
                        array('label'=>'Encuestas', 'url'=>array('/poll'),'visible'=>!Yii::app()->user->isGuest),
                         array('label'=>'Reporte', 'url'=>array('/poll/report'),'visible'=>!Yii::app()->user->isGuest),
                        //array('label'=>'Preguntas', 'url'=>array('/question'),'visible'=>!Yii::app()->user->isGuest),
                        //array('label'=>'Opciones', 'url'=>array('/optionQ'),'visible'=>!Yii::app()->user->isGuest),
						...
						//array('label'=>'Features <span></span>', 'url'=>array('/site/page', 'view'=>'columns')),
                        /*'itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"cool features"), 
                        'items'=>array(
